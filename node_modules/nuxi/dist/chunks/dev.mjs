...
import { d as defineCommand, a, A, c as consola } from '../shared/nuxi.DSPrE7vg.mjs';
import './index2.mjs';
import 'node:http';
import 'node:https';
import 'node:util';
...
async function _createDevProxy(nuxtOptions, listenOptions) {
  ...
  const loadingTemplate = nuxtOptions.devServer.loadingTemplate ?? await importModule("@nuxt/ui-templates", nuxtOptions.modulesDir).then((r) => r.loading);
